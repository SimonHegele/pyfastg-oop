...
class FastgReader(FastaReader):
    ...
    def extract_edge_properties(cls, edge_descriptor)->dict:
        ...
        dict
            ...
            edge properties
        """
        rc = True if edge_descriptor.endswith("'") else False # Probably refers to the strand
        if rc:
